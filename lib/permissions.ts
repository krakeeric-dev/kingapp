...
export const pagePermissions: Record<string, UserRole[]> = {
  ...
  "/call-center/messages": ["admin", "manager", "callcenter"],
  "/call-center/chat": ["admin", "manager", "callcenter"],
  "/call-center/announcements": ["admin", "manager", "callcenter"],
  ...
  "/call-center/performance": ["admin", "manager"],
  "/call-center/recordings": ["admin", "manager"],
